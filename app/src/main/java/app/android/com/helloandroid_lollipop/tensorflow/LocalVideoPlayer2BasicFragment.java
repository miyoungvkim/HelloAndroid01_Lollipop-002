...
public class LocalVideoPlayer2BasicFragment extends Fragment
    implements FragmentCompat.OnRequestPermissionsResultCallback {

  /** Tag for the {@link Log}. */
  private static final String TAG = "TfLiteLocalVideoDemo";
  ...
  public static LocalVideoPlayer2BasicFragment newInstance() {
    return new LocalVideoPlayer2BasicFragment();
  }
  ...
  public View onCreateView(
    ...
    return inflater.inflate( R.layout.fragment_localvideoplayer_basic, container, false);
  }
  ...
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    ...
    myVideoView = (VideoView) view.findViewById(R.id.video_texture);
    //////////////////////
    // video start
    Activity activity = getActivity();
    mContext = view.getContext();
    String video_url = "android.resource://"+getActivity().getPackageName()+"/raw/pororo01";
    // String video_url = "android.resource://"+getActivity().getPackageName()+"/raw/tensorflow_sample";
    ...
    Button buttonCapture = (Button)view.findViewById(R.id.capture);
  ...
  MediaPlayer.OnCompletionListener myVideoViewCompletionListener =
          new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer arg0) {
              Toast.makeText(mContext, "End of Video",
                      Toast.LENGTH_SHORT).show();
            }
          };
  ...
  /** Opens the camera specified by {@link LocalVideoPlayer2BasicFragment#cameraId}. */
  ...
  private void classifyFrame() {
    ...
    try {
      int currentPosition = myVideoView.getCurrentPosition(); //in millisecond
      Bitmap bitmap = mediaMetadataRetriever.getFrameAtTime(currentPosition); //unit in microsecond
      bitmap.setWidth(224);
